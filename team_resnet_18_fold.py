...
md = ImageData(path, dataset, bs=8, num_workers=8, classes=None)
...
learn.metrics = [my_dice_loss, loss_part1_focal2, loss_part2_dice]
...
print("Start training for 30 epochs...\n")
learn.fit(5e-4, n_cycle=2, cycle_len=10, use_clr=(20, 10))
learn.save(f"team_resnet18_fold_{FOLD}")
